...
while val == "y":
          ...
          if  credit_p in range (0,121,20):
              ...
              if credit_d in range (0,121,20):
                  ...
                  if credit_f in range (0,121,20):
                      ...
                      if total_of_credits  <120 or  total_of_credits>120:
                      ...
                      elif total_of_credits == 120:      # display outcome according to user inputs
                         if credit_p  == 120:
                             print("\nProgress")
                             outcome = "progress"
                             progress+=1
                         ...
                         dlist.append([outcome,credit_p,credit_d,credit_f])  # user inputs  store in a list
     ...
     if val == "q":
          ...
          for item in dlist:       # display user inputs and outcomes  from a list

...
while val == "y":
     ...
     if val == "q":
          print("-"*80,end="")
          print("Vertical Histrogram")   # display histrogrm vertical version
          ...
          for x in range (max(progress,trailer,retriever,excluded)):
               print(f'{"   *"if x < progress else " " :11}  {" *" if x < trailer else " " :12} {"*" if x < retriever else " " :13} {"*" if x < excluded else " " :14} ')

...
def cat_3():
    "Store  guessing words, if player select category 3 display category relevant guessing words"
...
# Display hint        
        ...
        if lens == 6:
            print("\nHINT :This country is famous for ice hockey")
                  
        elif lens == 8:
            print("\nHINT :It has the eighth wonder of the world ")
                   
        elif lens == 9:
            print("\nHINT :this country 2021 t20 Worldcup Runnersup")
            
        elif lens == 5:
            print("\nHINT :Since 1945 it has been divided between two countries")
        
        elif lens == 7:
            print("\nHINT :The largest division of the united kingdom")

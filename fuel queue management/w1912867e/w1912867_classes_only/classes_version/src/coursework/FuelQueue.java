...
public class FuelQueue {
    ...
    static String[] queue4 = new String[6];
    static  String[] queue5 = new String[6];
    ...
    public static void mainMenu() {
        ...
        //initialize
        initialize(queue1, queue2, queue3, queue4, queue5);
    ...
    private static void initialize(String[] que1ref, String[] que2ref, String[] que3ref,String[] que4ref,String[] que5ref) {
        ...
        for (int i = 0; i < queue_4; i++) que4ref[i] = "Empty";

        for (int i = 0; i < queue_5; i++) que5ref[i] = "Empty";
    ...
    public static void viewAllQueues() {
        ...
        for (int i = 0; i < queue_4; ) {
            System.out.println(queue4[i]);
            i++;
        }
        ...
        for (int i = 0; i < queue_5; ) {
            System.out.println(queue5[i]);
            i++;
        }
    ...
    public static void addToQueue() {
        /* add customer into one of the three queue when  customer added they are
        given  token number to customer*/
    ...
    public static void displayEmptyQueues() {
        ...
        for (int i = 0; i < queue_4; i++) {
            if (queue4[i].equals("Empty")) {
                System.out.println("Empty");
            } else
                System.out.println(" token number" + i + " occupied by " + queue4[i]);
        }
        System.out.println("  ");
        System.out.println("Queue 5\n");
        for (int i = 0; i < queue_5; i++) {
            if (queue5[i].equals("Empty")) {
                System.out.println("Empty");
            } else
                System.out.println(" token number" + i + " occupied by " + queue5[i]);
        }
    }
    ...
    public static void alphabetOrderName () {
        ...
        if (queuenum == 1) {
            ...
            String temp;
            for (int i = 0; i < queue_4; i++) {
                for (int j = i + 1; j < queue_4; j++) {

                    // to compare one string with other strings
                    if (queue4[i].compareTo(queue4[j]) > 0) {
                        // swapping
                        temp = queue4[i];
                        queue4[i] = queue4[j];
                        queue4[j] = temp;
            ...
            String temp;
            for (int i = 0; i < queue_5; i++) {
                for (int j = i + 1; j < queue_5; j++) {

                    // to compare one string with other strings
                    if (queue5[i].compareTo(queue5[j]) > 0) {
                        // swapping
                        temp = queue5[i];
                        queue5[i] = queue5[j];
                        queue5[j] = temp;
        ...
        try {
            ...
            for (int i = 0; i < queue_4; i++) {
                ...
                if (queue4[i].equals("Empty")) {
                    ...
                    filedata = "token " + " " + i + " occupied by " + queue4[i] + "\n";
                storefile.write(filedata.getBytes());
            }
            ...
            for (int i = 0; i < queue_5; i++) {
                ...
                if (queue5[i].equals("Empty")) {
                    ...
                    filedata = "token " + " " + i + " occupied by " + queue5[i] + "\n";
                storefile.write(filedata.getBytes());
            }
